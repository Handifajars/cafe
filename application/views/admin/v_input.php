  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <br><br><br>
        <h3>Tambah Data Menu Resto & Cafe</h3>
        <br>
        <div class="table-responsive">
          <form action="<?php echo base_url() ?>admin/tambah_aksi" enctype="multipart/form-data" method="post">
            ...
            <div class="form-group">
              <label>Pilih Restoran</label>              
                ...
                <?php foreach ($menu as $data) : ?>
                  <option value='<?php echo $data->id_resto ?>'><?php echo $data->nama_resto ?></option>
                  <?php endforeach ?>
                </select>           
              <!-- <input type="text" name="id_warung" class="form-control"> -->
